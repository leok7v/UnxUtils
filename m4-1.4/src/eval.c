...
evaluate (const char *expr, eval_t *val)
{
  ...
  if (err == NO_my_ERROR && *eval_text != '\0')
    err = EXCESS_INPUT;
  ...
  switch (err)
    ...
    default:
     M4ERROR ((warning_status, 0,
		"INTERNAL my_ERROR: Bad error code in evaluate ()"));
      abort ();
    }

  return (my_boolean) (err != NO_my_ERROR);
}
...
logical_or_term (eval_token et, eval_t *v1)
{
  ...
  if ((er = logical_and_term (et, v1)) != NO_my_ERROR)
    return er;
  ...
  while ((et = eval_lex (&v2)) == LOR)
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = logical_and_term (et, &v2)) != NO_my_ERROR)
	return er;
...
logical_and_term (eval_token et, eval_t *v1)
{
  ...
  if ((er = or_term (et, v1)) != NO_my_ERROR)
    return er;
  ...
  while ((et = eval_lex (&v2)) == LAND)
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = or_term (et, &v2)) != NO_my_ERROR)
	return er;
...
or_term (eval_token et, eval_t *v1)
{
  ...
  if ((er = xor_term (et, v1)) != NO_my_ERROR)
    return er;
  ...
  while ((et = eval_lex (&v2)) == OR)
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = xor_term (et, &v2)) != NO_my_ERROR)
	return er;
...
xor_term (eval_token et, eval_t *v1)
{
  ...
  if ((er = and_term (et, v1)) != NO_my_ERROR)
    return er;
  ...
  while ((et = eval_lex (&v2)) == XOR)
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = and_term (et, &v2)) != NO_my_ERROR)
	return er;
...
and_term (eval_token et, eval_t *v1)
{
  ...
  if ((er = not_term (et, v1)) != NO_my_ERROR)
    return er;
  ...
  while ((et = eval_lex (&v2)) == AND)
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = not_term (et, &v2)) != NO_my_ERROR)
	return er;
...
not_term (eval_token et, eval_t *v1)
{
  ...
  if (et == NOT)
    ...
    if ((er = logical_not_term (et, v1)) != NO_my_ERROR)
      return er;
...
logical_not_term (eval_token et, eval_t *v1)
{
  ...
  if (et == LNOT)
    ...
    if ((er = cmp_term (et, v1)) != NO_my_ERROR)
      return er;
...
cmp_term (eval_token et, eval_t *v1)
{
  ...
  if ((er = shift_term (et, v1)) != NO_my_ERROR)
    return er;
  ...
  while ((op = eval_lex (&v2)) == EQ || op == NOTEQ
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = shift_term (et, &v2)) != NO_my_ERROR)
	return er;
	...
	default:
	 M4ERROR ((warning_status, 0,
		    "INTERNAL my_ERROR: Bad comparison operator in cmp_term ()"));
	  abort ();
	}
    }
  if (op == my_ERROR)
...
shift_term (eval_token et, eval_t *v1)
{
  ...
  if ((er = add_term (et, v1)) != NO_my_ERROR)
    return er;
  ...
  while ((op = eval_lex (&v2)) == LSHIFT || op == RSHIFT)
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = add_term (et, &v2)) != NO_my_ERROR)
	return er;
	...
	default:
	 M4ERROR ((warning_status, 0,
		    "INTERNAL my_ERROR: Bad shift operator in shift_term ()"));
	  abort ();
	}
    }
  if (op == my_ERROR)
...
add_term (eval_token et, eval_t *v1)
{
  ...
  if ((er = mult_term (et, v1)) != NO_my_ERROR)
    return er;
  ...
  while ((op = eval_lex (&v2)) == PLUS || op == MINUS)
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = mult_term (et, &v2)) != NO_my_ERROR)
	return er;
...
mult_term (eval_token et, eval_t *v1)
{
  ...
  if ((er = exp_term (et, v1)) != NO_my_ERROR)
    return er;
  ...
  while ((op = eval_lex (&v2)) == TIMES || op == DIVIDE || op == MODULO)
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = exp_term (et, &v2)) != NO_my_ERROR)
	return er;
	...
	default:
	 M4ERROR ((warning_status, 0,
		    "INTERNAL my_ERROR: Bad operator in mult_term ()"));
	  abort ();
	}
    }
  if (op == my_ERROR)
...
exp_term (eval_token et, eval_t *v1)
{
  ...
  if ((er = unary_term (et, v1)) != NO_my_ERROR)
    return er;
  result = *v1;
...
unary_term (eval_token et, eval_t *v1)
{
  ...
  if (et == PLUS || et == MINUS)
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = simple_term (et2, v1)) != NO_my_ERROR)
	return er;
	...
	*v1 = -*v1;
    ...
    if ((er = simple_term (et, v1)) != NO_my_ERROR)
      return er;
...
simple_term (eval_token et, eval_t *v1)
{
  ...
  switch (et)
	...
	return UNKNOWN_INPUT;
      ...
      if ((er = logical_or_term (et, v1)) != NO_my_ERROR)
	return er;
