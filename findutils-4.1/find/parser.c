...
#endif

static myboolean parse_amin P_((char *argv[], int *arg_ptr));
static myboolean parse_and P_((char *argv[], int *arg_ptr));
static myboolean parse_anewer P_((char *argv[], int *arg_ptr));
static myboolean parse_atime P_((char *argv[], int *arg_ptr));
myboolean parse_close P_((char *argv[], int *arg_ptr));
static myboolean parse_cmin P_((char *argv[], int *arg_ptr));
static myboolean parse_cnewer P_((char *argv[], int *arg_ptr));
static myboolean parse_comma P_((char *argv[], int *arg_ptr));
static myboolean parse_ctime P_((char *argv[], int *arg_ptr));
static myboolean parse_daystart P_((char *argv[], int *arg_ptr));
static myboolean parse_depth P_((char *argv[], int *arg_ptr));
static myboolean parse_empty P_((char *argv[], int *arg_ptr));
static myboolean parse_exec P_((char *argv[], int *arg_ptr));
static myboolean parse_false P_((char *argv[], int *arg_ptr));
static myboolean parse_fls P_((char *argv[], int *arg_ptr));
static myboolean parse_fprintf P_((char *argv[], int *arg_ptr));
static myboolean parse_follow P_((char *argv[], int *arg_ptr));
static myboolean parse_fprint P_((char *argv[], int *arg_ptr));
static myboolean parse_fprint0 P_((char *argv[], int *arg_ptr));
static myboolean parse_fstype P_((char *argv[], int *arg_ptr));
static myboolean parse_gid P_((char *argv[], int *arg_ptr));
static myboolean parse_group P_((char *argv[], int *arg_ptr));
static myboolean parse_help P_((char *argv[], int *arg_ptr));
static myboolean parse_ilname P_((char *argv[], int *arg_ptr));
static myboolean parse_iname P_((char *argv[], int *arg_ptr));
static myboolean parse_inum P_((char *argv[], int *arg_ptr));
static myboolean parse_ipath P_((char *argv[], int *arg_ptr));
static myboolean parse_iregex P_((char *argv[], int *arg_ptr));
static myboolean parse_links P_((char *argv[], int *arg_ptr));
static myboolean parse_lname P_((char *argv[], int *arg_ptr));
static myboolean parse_ls P_((char *argv[], int *arg_ptr));
static myboolean parse_maxdepth P_((char *argv[], int *arg_ptr));
static myboolean parse_mindepth P_((char *argv[], int *arg_ptr));
static myboolean parse_mmin P_((char *argv[], int *arg_ptr));
static myboolean parse_mtime P_((char *argv[], int *arg_ptr));
static myboolean parse_name P_((char *argv[], int *arg_ptr));
static myboolean parse_negate P_((char *argv[], int *arg_ptr));
static myboolean parse_newer P_((char *argv[], int *arg_ptr));
static myboolean parse_noleaf P_((char *argv[], int *arg_ptr));
static myboolean parse_nogroup P_((char *argv[], int *arg_ptr));
static myboolean parse_nouser P_((char *argv[], int *arg_ptr));
static myboolean parse_ok P_((char *argv[], int *arg_ptr));
myboolean parse_open P_((char *argv[], int *arg_ptr));
static myboolean parse_or P_((char *argv[], int *arg_ptr));
static myboolean parse_path P_((char *argv[], int *arg_ptr));
static myboolean parse_perm P_((char *argv[], int *arg_ptr));
myboolean parse_print P_((char *argv[], int *arg_ptr));
static myboolean parse_print0 P_((char *argv[], int *arg_ptr));
static myboolean parse_printf P_((char *argv[], int *arg_ptr));
static myboolean parse_prune P_((char *argv[], int *arg_ptr));
static myboolean parse_regex P_((char *argv[], int *arg_ptr));
static myboolean insert_regex P_((char *argv[], int *arg_ptr, myboolean ignore_case));
static myboolean parse_size P_((char *argv[], int *arg_ptr));
static myboolean parse_true P_((char *argv[], int *arg_ptr));
static myboolean parse_type P_((char *argv[], int *arg_ptr));
static myboolean parse_uid P_((char *argv[], int *arg_ptr));
static myboolean parse_used P_((char *argv[], int *arg_ptr));
static myboolean parse_user P_((char *argv[], int *arg_ptr));
static myboolean parse_version P_((char *argv[], int *arg_ptr));
static myboolean parse_xdev P_((char *argv[], int *arg_ptr));
static myboolean parse_xtype P_((char *argv[], int *arg_ptr));

static myboolean insert_regex P_((char *argv[], int *arg_ptr, myboolean ignore_case));
static myboolean insert_type P_((char *argv[], int *arg_ptr, myboolean (*which_pred )()));
static myboolean insert_fprintf P_((FILE *fp, myboolean (*func )(), char *argv[], int *arg_ptr));
static struct segment **make_segment P_((struct segment **segment, char *format, int len, int kind));
static myboolean insert_exec_ok P_((myboolean (*func )(), char *argv[], int *arg_ptr));
static myboolean get_num_days P_((char *str, unsigned long *num_days, enum comparison_type *comp_type));
static myboolean insert_time P_((char *argv[], int *arg_ptr, PFB pred));
static myboolean get_num P_((char *str, unsigned long *num, enum comparison_type *comp_type));
static myboolean insert_num P_((char *argv[], int *arg_ptr, PFB pred));
...
static myboolean fprintf_stat_needed;
