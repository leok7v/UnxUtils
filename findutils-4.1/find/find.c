...
static int process_path P_((char *pathname, char *name, myboolean leaf, char *parent));
static void process_dir P_((char *pathname, char *name, int pathlen, struct stat *statp, char *parent));
static myboolean no_side_effects P_((struct predicate *pred));
